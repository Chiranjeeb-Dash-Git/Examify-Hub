...
import { ArrowRight, AlertCircle, Sparkles, UserCheck } from 'lucide-react';
...
export const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-white/20 selection:text-white font-body relative overflow-hidden flex flex-col justify-between">
      ...
      {/* Main Content Grid */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-6 z-10 my-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 hidden sm:block">
            ...
            <Reveal delay={100}>
              <h1 className="font-display font-extrabold text-4xl sm:text-6xl text-white tracking-tighter uppercase leading-[0.95]">
                JOIN THE <br />
                <span className="text-white/40">DIRECTIVE.</span>
              </h1>
            </Reveal>

            <Reveal delay={200}>
              <p className="font-body text-sm sm:text-base text-white/60 max-w-md leading-relaxed">
                Initialize your candidate profile, access real-time assessment telemetry, and join the Examify Hub evaluation network.
              </p>
            </Reveal>
          ...
          {/* Right Column: Obsidian Glass Register Form Card */}
          <div className="lg:col-span-6 lg:col-start-7 w-full max-w-md mx-auto lg:max-w-none">
            <Reveal delay={200}>
              <div className="bg-[#0a0a0a] border border-white/10 p-8 sm:p-10 rounded-3xl backdrop-blur-xl shadow-2xl space-y-6 hover:border-white/20 transition-all duration-500 relative">
                {/* Header */}
                <div className="space-y-2 border-b border-white/10 pb-5">
                  <div className="flex items-center justify-between">
                    <span className="font-mono text-[11px] text-white/40 uppercase tracking-widest">
                      SYSTEM REGISTRATION // REG-SYS
                    </span>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-[#050505] border border-white/10 text-white placeholder-white/30 font-body text-sm focus:outline-none focus:border-white/40 transition-all"
                    />
                  </div>
      ...
      <footer className="py-6 border-t border-white/10 z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between font-mono text-[11px] text-white/40">
          <span>EXAMIFY HUB CANDIDATE REGISTRATION</span>
